  ...
  return (
    <View style={styles.safe}>
      <View style={styles.card}>
        ...
        <Text style={styles.nombre}>{perfil?.nombre || 'Administrador'}</Text>
      ...
      <TouchableOpacity style={styles.botonSalir} onPress={() =>
...
const styles = StyleSheet.create({
  ...
  rolBadge: { backgroundColor: '#2563eb', paddingHorizontal: 16, paddingVertical: 6, borderRadius: 20, marginTop: 14 },
